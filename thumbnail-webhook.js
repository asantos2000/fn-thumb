...
app.post('/', function (req, res) {
    ...
    var cache = [];
    var event = JSON.stringify(req, function(key, value) {
...
var putFile = function (name, stream) {
    console.log("Uploading...");
    var thumbnailName = name.split('.')[0] + "-thumbnail.jpg";
    console.log("\"" + thumbnailName + "\"", "to \"" + mcConfig.destBucket + "\"");
